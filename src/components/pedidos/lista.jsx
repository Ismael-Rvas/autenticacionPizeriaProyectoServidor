...
export default async function Pedidos() {
    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            {pedidos.map((pedido) => (
                <div key={pedido.id} className="p-6 mb-6 bg-slate-200 rounded-lg shadow-lg">
                    <div className="flex flex-col gap-2">
                        ...
                        <p className="text-gray-600">Nombre del cliente: {pedido.nombre_cliente}</p>
                        <p className="text-gray-600">Dirección del cliente: {pedido.direccion_cliente}</p>
